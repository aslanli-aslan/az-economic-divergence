...
current_account = wbdata.get_dataframe(
    {"BN.CAB.XOKA.CD": "current_account"}, country="AZ"
)


# Unemployment Rate
unemployment_rate = wbdata.get_dataframe(
    {"SL.UEM.TOTL.ZS": "unemployment_rate"}, country="AZ"
)


# Exports % of GDP
exports_pct_gdp = wbdata.get_dataframe(
    {"NE.EXP.GNFS.ZS": "exports_pct_gdp"}, country="AZ"
)


# Imports % of GDP
imports_pct_gdp = wbdata.get_dataframe(
    {"NE.IMP.GNFS.ZS": "imports_pct_gdp"}, country="AZ"
)
